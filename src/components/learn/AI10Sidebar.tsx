  ...
  return (
    ...
    >
      ...
      >
        <div className="p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-[10px] text-gray-400 font-medium">Class X · 2026–27</span>
          </div>
          ...
          <p className="text-xs text-gray-400">0 of 6 units complete</p>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto p-2.5 space-y-0.5">
        {UNITS.map((u) => {
          const active = pathname === `/learn/cbse-ai-class10/module-${u.num}`
