...
const LESSONS = [
  { id: "lesson-01", num: "01", label: "What is AI?",    color: "#3B82F6" },
  { id: "lesson-02", num: "02", label: "Project Cycle",  color: "#F97316" },
  { id: "lesson-03", num: "03", label: "Ethics & Bias",  color: "#7C3AED" },
]
