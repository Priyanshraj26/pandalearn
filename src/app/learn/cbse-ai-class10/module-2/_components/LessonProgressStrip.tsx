...
const LESSONS = [
  { id: "lesson-01", num: "01", label: "AI, ML & DL",       color: "#3B82F6" },
  { id: "lesson-02", num: "02", label: "ML Model Types",    color: "#F97316" },
  { id: "lesson-03", num: "03", label: "Neural Networks",   color: "#7C3AED" },
]
