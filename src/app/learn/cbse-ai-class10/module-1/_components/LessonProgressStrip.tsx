...
const LESSONS = [
  { id: "lesson-01", num: "01", label: "AI Project Cycle",     color: "#3B82F6" },
  { id: "lesson-02", num: "02", label: "Ethical Frameworks",   color: "#F97316" },
  { id: "lesson-03", num: "03", label: "Bioethics & Case Study", color: "#7C3AED" },
]
