...
const LESSONS = [
  { id: "lesson-01", num: "01", label: "No-Code AI Intro",    color: "#3B82F6" },
  { id: "lesson-02", num: "02", label: "Tools & Use Cases",   color: "#F97316" },
]
          ...
          <div className="ml-auto flex items-center gap-2 shrink-0">
            ...
            <div className="w-16 h-1.5 bg-gray-100 rounded-full overflow-hidden">
              <motion.div
                ...
                style={{ background: LESSONS[activeIdx]?.color ?? "#F97316" }}
                animate={{ width: `${pct}%` }}
