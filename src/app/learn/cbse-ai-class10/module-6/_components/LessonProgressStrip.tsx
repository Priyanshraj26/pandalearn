...
const LESSONS = [
  { id: "lesson-01", num: "01", label: "NLP Fundamentals",  color: "#3B82F6" },
  { id: "lesson-02", num: "02", label: "TF-IDF",            color: "#F97316" },
  { id: "lesson-03", num: "03", label: "Applications",      color: "#7C3AED" },
]
