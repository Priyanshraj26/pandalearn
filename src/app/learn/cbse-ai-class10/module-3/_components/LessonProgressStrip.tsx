...
const LESSONS = [
  { id: "lesson-01", num: "01", label: "Why Evaluate?",      color: "#3B82F6" },
  { id: "lesson-02", num: "02", label: "Confusion Matrix",   color: "#F97316" },
  { id: "lesson-03", num: "03", label: "Metrics & Ethics",   color: "#7C3AED" },
]
