      ...
      <div className="py-10 space-y-14">
              ...
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="text-left p-2.5 font-bold text-gray-600 border-b border-gray-200">Type</th>
                    <th className="text-left p-2.5 font-bold text-gray-600 border-b border-gray-200">Scope</th>
                    <th className="text-left p-2.5 font-bold text-gray-600 border-b border-gray-200">Real-world example</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    <tr key={t} className="hover:bg-gray-50 transition-colors">
                      <td className="p-2.5 font-bold text-violet-700">{t}</td>
                      <td className="p-2.5 text-gray-600">{s}</td>
                      <td className="p-2.5 text-gray-600">{e}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              ...
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-gray-50">
                    {["Topology", "Layout", "Pros", "Cons"].map(h => (
                      <th key={h} className="text-left p-2.5 font-bold text-gray-600 border-b border-gray-200">
                        {h}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    <tr key={t} className="hover:bg-gray-50 transition-colors">
                      <td className="p-2.5 font-semibold text-violet-700">{t}</td>
                      <td className="p-2.5 text-gray-600">{l}</td>
          ...
          <ConceptCard number="1.5" title="Why Protocols Exist" tag="Key Concept">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {["TCP/IP", "HTTP", "DNS", "TLS", "SMTP", "SSH", "WebSocket"].map(p => (
                <span
                  key={p}
                  className="text-xs bg-violet-50 text-violet-700 border border-violet-200 px-2.5 py-1 rounded-full font-mono"
                >
                  {p}
                </span>
              ))}
        ...
        <section>
          ...
          <p className="text-sm text-gray-500 text-center mb-8">
            Score <strong className="text-gray-700">5 / 10</strong> or higher to unlock Module 2.
          </p>
