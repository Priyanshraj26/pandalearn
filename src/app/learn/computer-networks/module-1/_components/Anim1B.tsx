...
export default function Anim1B() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-95">
      ...
      <div className="flex-1 relative bg-[#0F172A] overflow-hidden min-h-80">
        ...
        >
          ...
          {t.nodes.map((n, i) => {
            ...
            let fill   = isHub ? "#7C3AED" : "#E2E8F0"
            let stroke = isHub ? "#5B21B6" : "#94A3B8"
                ...
                >
                  ...
                  {!isBroken && (
                    <g transform={`translate(${n.x - 7}, ${n.y - 6})`} pointerEvents="none">
                      <rect x={1} y={1} width={12} height={8} rx={1} fill="none" stroke={isHub ? "#C4B5FD" : "#64748B"} strokeWidth={1.2} />
                      <rect x={0} y={9} width={14} height={1.5} rx={0.5} fill={isHub ? "#C4B5FD" : "#64748B"} />
                    </g>
                  )}
      ...
      {/* ── right panel ── */}
      <div className="md:w-56 shrink-0 bg-white border-l border-gray-200 p-4 flex flex-col gap-4">
        {/* topology selector */}
        <div>
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Topology</p>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div>
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Stats</p>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-500">Fault tolerance</span>
                  <span
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-semibold text-gray-700">{t.edges.length}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-500">SPOF</span>
