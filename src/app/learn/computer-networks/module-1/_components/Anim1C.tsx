    ...
    <div className="flex flex-col items-center gap-1.5">
      ...
      >
        <svg viewBox="0 0 40 36" width={34} height={30}>
          ...
          <circle cx={16} cy={18} r={2.5} fill={active ? "#7C3AED" : "#334155"} />
      ...
      <span className="text-xs font-semibold text-gray-400">Router</span>
      <span className="text-[10px] text-gray-500 font-mono">192.168.1.1</span>
    </div>
  )
}
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex gap-1">
            <input
              ...
              className="w-28 text-xs px-2.5 py-1.5 rounded-lg bg-[#1E293B] border border-[#334155] text-white placeholder:text-gray-500 focus:outline-none focus:border-violet-500 disabled:opacity-50"
            />
            <button
              onClick={send}
              disabled={traveling || !input.trim()}
              className="w-7 h-7 rounded-lg bg-violet-600 hover:bg-violet-500 flex items-center justify-center disabled:opacity-40 transition-colors"
            >
      ...
      >
        ...
        <AnimatePresence>
          {inspecting && (
            ...
            >
              <p className="text-gray-400 font-bold uppercase tracking-wide mb-1.5">Packet Inspector</p>
              <div className="space-y-1">
                <Row label="Source"      value="192.168.1.10" valueClass="text-violet-300" />
                <Row label="Destination" value="192.168.1.20" valueClass="text-violet-300" />
                <Row label="Protocol"    value="TCP"          valueClass="text-emerald-400" />
                <Row label="TTL"         value={String(ttl)}  valueClass={ttl < 64 ? "text-amber-400" : "text-gray-300"} />
