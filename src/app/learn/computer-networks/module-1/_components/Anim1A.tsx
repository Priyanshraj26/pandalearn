...
export default function Anim1A() {
  ...
  return (
    <div className="grid md:grid-cols-2 gap-0 min-h-95">
      ...
      {/* ── info panel ── */}
      <div className="relative overflow-hidden flex flex-col justify-center p-6 bg-white">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h3 className="font-sora text-xl font-bold text-gray-900 mb-1">{active.label}</h3>
            <p className="text-sm text-gray-500 mb-4">{active.range}</p>

            <div className="space-y-2.5">
              <div className="flex items-start gap-3">
                <span className="text-xs font-semibold text-gray-400 w-20 shrink-0 mt-0.5">Example</span>
                <span className="text-sm text-gray-700">{active.example}</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-xs font-semibold text-gray-400 w-20 shrink-0 mt-0.5">Bandwidth</span>
                <span className="text-sm text-gray-700 font-mono">{active.bw}</span>
              </div>
            </div>
