  ...
  return (
    <div className="bg-[#0F172A] min-h-[420px] p-5 flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          onClick={reset}
          className="flex items-center gap-1.5 px-3 py-1.5 bg-[#1E293B] hover:bg-[#334155] text-gray-400 rounded-lg text-xs border border-[#334155] transition-colors"
        >
        ...
        <div className="relative flex items-center gap-3 px-2">
          <div className="flex flex-col items-center gap-1">
            <div className="w-10 h-10 rounded-xl bg-[#1E293B] border border-[#334155] flex items-center justify-center">
              <span className="text-[10px] text-gray-400 font-bold">NIC</span>
            </div>
            <span className="text-[8px] text-gray-500">Sender</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-[8px] text-gray-500">Receiver</span>
          </div>
        </div>
      )}
      ...
      <AnimatePresence>
        {exploded && (
          ...
          >
            <p className="text-[9px] text-gray-500 uppercase font-bold tracking-wider">Click any field to inspect</p>
            ...
            <div className="flex rounded-xl overflow-hidden border border-[#334155]">
              {FRAME_FIELDS.map(f => (
                ...
                >
                  ...
                  <span className="text-[6px] text-gray-400">{f.bytes}</span>
                </button>
              ))}
            </div>
                ...
                {selectedField ? (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="font-sora font-bold text-sm text-white">{selectedField.name}</span>
                      <span className="ml-auto text-[10px] text-gray-500 font-mono">{selectedField.bytes}</span>
                    </div>
                    ...
                    <p className="text-xs text-gray-400 leading-relaxed flex-1">{selectedField.desc}</p>
                  </motion.div>
                ) : (
                  <p className="text-xs text-gray-600 text-center mt-4">Select a field above</p>
                )}
              </div>
