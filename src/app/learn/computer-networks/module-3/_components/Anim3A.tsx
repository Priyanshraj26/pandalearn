...
export default function Anim3A() {
  ...
  const showCache     = phase === "cache" || phase === "done"
  ...
  return (
    <div className="bg-[#0F172A] min-h-[400px] p-5 flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          onClick={reset}
          className="flex items-center gap-1.5 px-3 py-1.5 bg-[#1E293B] hover:bg-[#334155] text-gray-400 rounded-lg text-xs transition-colors border border-[#334155]"
        >
              ...
              {arpCache ? (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[9px] text-gray-400">IP</span>
                    <span className="text-[9px] font-mono text-violet-300">{arpCache.ip}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[9px] text-gray-400">MAC</span>
                    <span className="text-[9px] font-mono text-emerald-300">{arpCache.mac}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[9px] text-gray-400">TTL</span>
                    <span className="text-[9px] font-mono text-amber-300">300s</span>
                  </div>
                </motion.div>
              ) : (
                <p className="text-[9px] text-gray-600 italic">empty</p>
              )}
            </AnimatePresence>
          </div>
          ...
          <div className="bg-[#1E293B] rounded-xl p-3 border border-[#334155] flex-1">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[9px] text-gray-400">Broadcast frame</span>
              </div>
              <div className="flex items-center gap-1.5">
                <div className="w-6 h-0.5 bg-violet-500" />
                <span className="text-[9px] text-gray-400">Unicast reply</span>
              </div>
              <div className="flex items-center gap-1.5">
                <div className="w-6 h-0.5 bg-emerald-500" />
                <span className="text-[9px] text-gray-400">Cache hit</span>
              </div>
            </div>
            {replayCount > 0 && (
              <motion.p
