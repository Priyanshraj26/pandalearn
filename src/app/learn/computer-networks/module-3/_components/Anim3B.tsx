      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {step >= 2 && phase === "done" && (
          <div className="flex items-center gap-2 ml-2">
            <span className="text-[10px] text-gray-400">Aging TTL:</span>
            <input
      ...
      <div className="flex gap-4 flex-1">
        ...
        <div className="w-52 shrink-0 flex flex-col gap-3">
          ...
          <div className="bg-[#1E293B] rounded-xl p-3 border border-[#334155] flex-1">
            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">MAC Address Table</p>
            {displayTable.length === 0 ? (
              <p className="text-[9px] text-gray-600 italic">empty</p>
            ) : (
              <div className="space-y-1.5">
                <div className="grid grid-cols-3 text-[8px] text-gray-500 font-bold pb-1 border-b border-[#334155]">
                ...
                <AnimatePresence>
                  {displayTable.map(e => (
                    ...
                    >
                      <span className="text-violet-300 truncate">{e.mac.slice(0, 5)}…</span>
