      ...
      <div className="py-10 space-y-14">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <ConceptCard number="3.1" title="Hardware Addresses" tag="Key Concept">
              <p>
                ...
                colon-separated hex pairs: <code className="text-violet-600">A4:C3:F0:85:7D:21</code>.
              </p>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={prop} className="hover:bg-gray-50">
                        <td className="p-2 font-semibold text-gray-700">{prop}</td>
                        <td className="p-2 text-violet-600 font-mono text-[11px]">{mac}</td>
        ...
        <section className="space-y-6">
          ...
          <ConceptCard number="3.2" title="Anatomy of an Ethernet Frame" tag="Key Concept">
            ...
            <div className="font-mono text-[10px] bg-gray-900 text-gray-300 rounded-xl p-3 mt-2 overflow-x-auto">
              <span className="text-gray-500">| </span>
              <span className="text-gray-400">Preamble(7B)</span>
              <span className="text-gray-500"> | </span>
              <span className="text-gray-400">SFD(1B)</span>
              <span className="text-gray-500"> | </span>
              <span className="text-amber-400">Dst MAC(6B)</span>
              <span className="text-gray-500"> | </span>
              <span className="text-violet-400">Src MAC(6B)</span>
              <span className="text-gray-500"> | </span>
        ...
        <section className="space-y-6">
          ...
          <ConceptCard number="3.3" title="The ARP Problem" tag="Key Concept">
            ...
            <p className="text-xs text-gray-500 mt-2">
              Run <code className="text-violet-600">arp -a</code> in any terminal to see your current ARP cache.
            </p>
          </ConceptCard>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={d} className="hover:bg-gray-50">
                        ...
                        <td className="p-2 text-gray-500 font-mono text-[10px]">{l}</td>
                        <td className="p-2 text-gray-600 text-[10px]">{i}</td>
                        <td className="p-2 text-gray-600 text-[10px]">{c}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <ConceptCard number="3.5–3.6" title="How a Switch Learns + VLANs" tag="Key Concept">
              ...
              <ol className="space-y-1 list-decimal list-inside text-xs text-gray-600">
                <li>Frame arrives on Port 3 from <code className="text-violet-600">AA:BB:…</code></li>
                <li>Switch records: <code className="text-violet-600">AA:BB:… → Port 3</code></li>
              ...
              <div className="bg-violet-50 border border-violet-100 rounded-xl p-2.5 mt-3">
                <p className="text-[10px] font-bold text-violet-700 mb-1">VLANs (802.1Q)</p>
        ...
        <section>
          ...
          <p className="text-sm text-gray-500 text-center mb-8">
            Score <strong className="text-gray-700">9 / 12</strong> or higher to unlock Module 4.
          </p>
