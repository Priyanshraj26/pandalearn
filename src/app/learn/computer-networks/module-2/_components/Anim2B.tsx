    ...
    <div className="relative grid md:grid-cols-[190px_1fr] min-h-95 bg-[#0F172A]">
      ...
      <div className="border-r border-[#1E293B] p-4 flex flex-col gap-2">
            ...
            return (
              <motion.button
                ...
                className={`flex items-center justify-between px-3 py-2 rounded-lg text-xs font-semibold text-left transition-all border ${
                  isPlaced
                    ? "opacity-35 border-[#1E293B] text-gray-500 cursor-default"
                    : isSelected
                    ? "border-violet-500 bg-violet-900/30 text-violet-200 shadow-[0_0_0_2px_#7C3AED33]"
                    : "border-[#1E293B] text-gray-300 hover:border-[#334155] hover:bg-[#1E293B] cursor-pointer"
                }`}
              >
        ...
        {allPlaced && (
          <button
            onClick={reset}
            className="mt-auto flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-xs text-gray-400 border border-[#334155] hover:bg-[#1E293B] transition-colors"
          >
          ...
          return (
            <motion.button
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl border text-left transition-all ${
                canDrop
                  ? "border-dashed border-[#334155] hover:border-violet-500 hover:bg-violet-900/15 cursor-pointer"
        ...
        {allPlaced && (
          ...
          >
            ...
            >
              ...
              <h3 className="font-sora text-xl font-bold text-gray-900 mb-1">All classified!</h3>
              <p className="text-gray-500 text-sm mb-1">
                <span className="text-emerald-600 font-bold text-lg">{totalCorrect}</span>
                <span className="text-gray-400"> / {ITEMS.length}</span> correct
              </p>
              ...
              <button
                onClick={reset}
                className="px-6 py-2.5 bg-violet-600 text-white rounded-xl font-semibold text-sm hover:bg-violet-500 transition-colors"
              >
                Play Again
              </button>
            </motion.div>
