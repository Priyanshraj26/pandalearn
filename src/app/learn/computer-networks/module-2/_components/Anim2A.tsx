    ...
    <div className="grid md:grid-cols-[1fr_210px] min-h-95">
      ...
      <div className="bg-[#0F172A] flex items-center gap-2 px-4 py-5 min-h-80 overflow-x-auto">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 px-2 min-w-0">
          <p className="text-[9px] text-gray-600 uppercase font-bold tracking-wider">
      ...
      {/* ── info panel ── */}
      <div className="bg-white border-l border-gray-200 p-5 flex flex-col gap-3">
        <AnimatePresence mode="wait">
          ...
          >
            <div>
              ...
              <h3 className="font-sora font-bold text-gray-900 text-sm leading-snug">{cur.title}</h3>
            </div>

            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">PDU</p>
            ...
            <p className="text-xs text-gray-600 leading-relaxed flex-1">{cur.desc}</p>
          </motion.div>
        </AnimatePresence>
...
function OsiStack({
  ...
  return (
    <div className="flex flex-col gap-1 w-28 shrink-0">
      <p className="text-[9px] text-gray-500 font-bold uppercase tracking-widest text-center mb-1">
        {label}
      </p>
      {OSI.map(l => {
