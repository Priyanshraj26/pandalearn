      ...
      <div className="py-10 space-y-14">
        ...
        <section className="space-y-6">
          ...
          <ConceptCard number="2.1" title="Seven Layers, One Framework" tag="Key Concept">
            ...
            <p className="text-xs text-gray-500 font-semibold">
              Mnemonic (top→bottom): <span className="text-violet-600">A</span>ll{" "}
              <span className="text-violet-600">P</span>eople{" "}
              <span className="text-violet-600">S</span>eem{" "}
              <span className="text-violet-600">T</span>o{" "}
              <span className="text-violet-600">N</span>eed{" "}
              <span className="text-violet-600">D</span>ata{" "}
              <span className="text-violet-600">P</span>rocessing
            </p>
                ...
                <thead>
                  <tr className="bg-gray-50">
                    {["Layer", "Name", "PDU", "Key Protocols / Devices"].map(h => (
                      <th key={h} className="text-left p-2.5 font-bold text-gray-600 border-b border-gray-200">{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    <tr key={n} className="hover:bg-gray-50 transition-colors">
                      <td className="p-2.5 font-bold text-violet-700">{n}</td>
                      <td className="p-2.5 font-semibold text-gray-800">{name}</td>
                      <td className="p-2.5 font-mono text-amber-600">{pdu}</td>
                      <td className="p-2.5 text-gray-500">{protos}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <section className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <ConceptCard number="2.2" title="Encapsulation" tag="Key Concept">
              ...
              <div className="bg-gray-900 rounded-xl p-3 font-mono text-[10px] text-gray-300 space-y-0.5 mt-1">
                <p><span className="text-violet-400">App:</span>   [HTTP Data]</p>
                ...
                <p><span className="text-gray-400">Phys:</span>  01001101 01110010 … (bits)</p>
              </div>
            </ConceptCard>
              ...
              <div className="space-y-1.5 mt-2">
                {[
                  ...
                  <div key={layer} className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-500 w-36 shrink-0">{layer}</span>
              ...
              <table className="w-full text-xs border-collapse">
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    <tr key={tcp} className="hover:bg-gray-50 transition-colors">
                      <td className="p-2.5 font-semibold text-violet-700">{tcp}</td>
                      <td className="p-2.5 text-gray-500 font-mono text-[11px]">{osi}</td>
                      <td className="p-2.5 text-gray-600">{protos}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <section>
          ...
          <p className="text-sm text-gray-500 text-center mb-8">
            Score <strong className="text-gray-700">11 / 15</strong> or higher to unlock Module 3.
          </p>
