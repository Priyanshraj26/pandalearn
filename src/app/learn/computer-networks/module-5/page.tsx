      ...
      <div className="py-10 space-y-14">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={r} className="hover:bg-gray-50">
                        <td className="p-2 font-mono text-violet-600 text-[10px]">{r}</td>
                        <td className="p-2 text-gray-700 text-[10px]">{n}</td>
                        <td className="p-2 text-gray-500 text-[10px]">{e}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <ConceptCard number="5.1" title="Sockets" tag="Definition">
              ...
              <div className="bg-gray-900 rounded-xl p-3 font-mono text-[10px] text-gray-300 mt-2 space-y-1">
                <p><span className="text-violet-400">Source IP</span>  : 192.168.1.10</p>
                <p><span className="text-violet-400">Source Port</span>: 54321 (ephemeral)</p>
        ...
        <section className="space-y-6">
          ...
          <ConceptCard number="5.6" title="The Sliding Window" tag="Key Concept">
            ...
            <div className="bg-gray-900 rounded-xl p-3 font-mono text-[10px] text-gray-300 mt-2 space-y-0.5">
              <p><span className="text-gray-500">|</span><span className="text-gray-500"> Ack'd </span><span className="text-gray-500">|</span><span className="text-violet-400"> Sent,unACK'd </span><span className="text-gray-500">|</span><span className="text-blue-400"> Can send (window) </span><span className="text-gray-500">|</span><span className="text-gray-600"> Cannot send yet </span><span className="text-gray-500">|</span></p>
            </div>
            <p className="text-xs text-gray-500 mt-2">
                ...
                <table className="w-full text-xs border-collapse">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="p-2 text-gray-500 text-[10px]">Mild</td>
                      <td className="p-2 text-gray-500 font-mono text-[10px]">→ ssthresh (Reno)</td>
                      <td className="p-2 text-gray-500 font-mono text-[10px]">cwnd / 2</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="p-2 text-red-600 font-semibold text-[10px]">Timeout</td>
                      <td className="p-2 text-gray-500 text-[10px]">Severe</td>
                      <td className="p-2 text-gray-500 font-mono text-[10px]">→ 1 MSS</td>
                      <td className="p-2 text-gray-500 font-mono text-[10px]">cwnd / 2</td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <ConceptCard number="5.8" title="UDP  User Datagram Protocol" tag="Key Concept">
              ...
              <div className="bg-gray-900 rounded-xl p-2.5 font-mono text-[9px] text-gray-300 mt-2">
                <p className="text-gray-500 mb-0.5">UDP Header (8 bytes total):</p>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={prop} className="hover:bg-gray-50">
                        <td className="p-2 font-semibold text-gray-700 text-[10px]">{prop}</td>
                        <td className="p-2 text-violet-600 text-[10px]">{tcp}</td>
        ...
        <section>
          ...
          <p className="text-sm text-gray-500 text-center mb-8">
            Score <strong className="text-gray-700">13 / 18</strong> or higher to unlock Module 6.
          </p>
