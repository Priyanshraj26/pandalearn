    ...
    <div className="bg-[#0F172A] p-5 flex flex-col gap-5 min-h-[400px]">
      ...
      <div className="grid grid-cols-2 gap-4 flex-1">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold text-violet-300 font-sora">TCP</span>
            <span className="text-[9px] text-gray-500">reliable, ordered</span>
          </div>
          ...
          <div className="flex flex-col gap-1 text-[10px]">
            ...
            <div className="flex justify-between">
              <span className="text-gray-400">Retransmits:</span>
            ...
            {done && (
              <div className="flex justify-between">
                ...
                <span className="text-violet-300 font-mono">~{tcpMs} ms</span>
              </div>
            )}
          </div>
          {done && (
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold text-blue-300 font-sora">UDP</span>
            <span className="text-[9px] text-gray-500">fast, no guarantee</span>
          </div>
