          ...
          <div className="flex justify-between px-8 mb-3">
            <div className="flex flex-col items-center gap-1">
              <div className="w-12 h-12 rounded-xl bg-[#1E293B] border border-[#334155] flex items-center justify-center">
                <span className="text-[10px] font-bold text-gray-300">CLI</span>
              </div>
              <span className="text-[9px] text-gray-500 font-bold uppercase tracking-wider">Client</span>
              <StatePill state={cur.clientState} />
            </div>
            <div className="flex flex-col items-center gap-1">
              <div className="w-12 h-12 rounded-xl bg-[#1E293B] border border-[#334155] flex items-center justify-center">
                <span className="text-[10px] font-bold text-gray-300">SRV</span>
              </div>
              <span className="text-[9px] text-gray-500 font-bold uppercase tracking-wider">Server</span>
        ...
        <div className="w-48 shrink-0 bg-[#1E293B] rounded-xl border border-[#334155] p-4 flex flex-col gap-3">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-xs text-gray-300 leading-relaxed">{cur.note}</p>
            </motion.div>
          </AnimatePresence>
            ...
            {steps.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  backgroundColor: i === stepIdx ? "#7C3AED" : "#334155",
                }}
              />
            ))}
          </div>
