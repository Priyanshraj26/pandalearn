...
function SectionHeading({ n, title }: { n: string; title: string }) {
  return (
    <div className="flex items-center gap-3">
      <span className="w-8 h-8 rounded-lg bg-violet-600 text-white font-sora font-bold text-sm flex items-center justify-center shrink-0">
        {n}
      </span>
      <h2 className="font-sora text-xl font-bold text-gray-900 whitespace-nowrap">{title}</h2>
  ...
  return (
    <div className="px-6 lg:px-10">
      ...
      <div className="pt-8 pb-2">
        <div className="relative overflow-hidden rounded-2xl bg-gray-900 px-8 py-10 text-white">
          ...
          <div className="relative flex items-start gap-6">
            <div className="w-16 h-16 rounded-2xl bg-white/10 border border-white/15 flex items-center justify-center font-sora font-extrabold text-3xl shrink-0">
              4
            </div>
            <div>
              ...
              <h1 className="font-sora text-3xl font-extrabold leading-tight tracking-tight">
      ...
      <div className="py-10 space-y-14">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <ConceptCard number="4.1" title="IPv4 Address Structure" tag="Key Concept">
              <p>
                ...
                octets: <code className="text-violet-600">192.168.1.100</code>.
                  ...
                  <thead>
                    <tr className="bg-gray-50">
                      {["Class", "Range", "Default Mask", "Use"].map(h => (
                        <th key={h} className="text-left p-2 font-bold text-gray-600 border-b border-gray-200 text-[10px]">{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={cls} className="hover:bg-gray-50">
                        ...
                        <td className="p-2 text-gray-600 font-mono text-[10px]">{range}</td>
                        <td className="p-2 text-gray-600 font-mono text-[10px]">{mask}</td>
                        <td className="p-2 text-gray-500 text-[10px]">{use}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <ConceptCard number="4.2" title="CIDR Notation" tag="Key Concept">
              <p>
                ...
                The <strong>prefix length</strong> (e.g. <code className="text-violet-600">/24</code>)
                tells you how many bits belong to the <em>network</em> portion.
              </p>
              <div className="bg-gray-900 rounded-xl p-3 font-mono text-[10px] text-gray-300 space-y-1 mt-2">
                <p><span className="text-violet-400">Hosts</span> = 2^(32 - prefix) - 2</p>
                ...
                <div className="border-t border-gray-700 pt-1 mt-1 space-y-0.5">
                  <p><span className="text-gray-500">/24</span> → <span className="text-emerald-400">254</span> hosts</p>
                  <p><span className="text-gray-500">/25</span> → <span className="text-emerald-400">126</span> hosts · 2 subnets per /24</p>
                  <p><span className="text-gray-500">/26</span> → <span className="text-emerald-400">62</span> hosts · 4 subnets per /24</p>
                  <p><span className="text-gray-500">/30</span> → <span className="text-emerald-400">2</span> hosts · point-to-point links</p>
                </div>
              </div>
            </ConceptCard>
            ...
            <ConceptCard number="4.2" title="Worked Example" tag="Example">
              <p className="text-xs text-gray-600 mb-2">
                Split <code className="text-violet-600">192.168.1.0/24</code> into 4 equal subnets:
              </p>
              ...
              <div className="bg-gray-50 rounded-xl p-2.5 mt-2.5 font-mono text-[10px] space-y-0.5">
                {[
              ...
              <p className="text-[10px] text-gray-500 mt-1.5">62 usable hosts per subnet</p>
            </ConceptCard>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <ConceptCard number="4.4" title="How Routers Forward Packets" tag="Key Concept">
              ...
              <div className="bg-gray-900 rounded-xl p-3 font-mono text-[10px] text-gray-300 mt-2 overflow-x-auto">
                <p className="text-gray-500 mb-1"># Destination     Next Hop     Iface</p>
                <p><span className="text-violet-400">192.168.1.0/24</span>  direct       eth0</p>
                <p><span className="text-blue-400">10.0.0.0/8</span>      192.168.1.1  eth1</p>
                <p><span className="text-gray-400">0.0.0.0/0</span>       203.0.113.1  eth2</p>
              </div>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={p} className="hover:bg-gray-50">
                        ...
                        <td className="p-2 text-gray-500 text-[10px]">{t}</td>
                        <td className="p-2 text-gray-500 font-mono text-[10px]">{a}</td>
                        <td className="p-2 text-gray-500 text-[10px]">{u}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    <tr key={t} className="hover:bg-gray-50">
                      <td className="p-2 font-semibold text-violet-600 text-[10px]">{t}</td>
                      <td className="p-2 text-gray-500 text-[10px]">{m}</td>
                      <td className="p-2 text-gray-500 text-[10px]">{u}</td>
                    </tr>
                  ))}
                </tbody>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <ConceptCard number="4.7" title="IPv6 Addressing" tag="Key Concept">
              ...
              <div className="bg-gray-900 rounded-xl p-3 font-mono text-[10px] text-gray-300 mt-2 space-y-1">
                ...
                <p className="text-violet-300">2001:0db8:85a3:0000:0000:8a2e:0370:7334</p>
                <p className="text-gray-500 mt-1">Simplified (omit leading zeros, compress ::):</p>
                <p className="text-violet-300">2001:db8:85a3::8a2e:370:7334</p>
              </div>
              <p className="text-xs text-gray-500 mt-2">
                <code className="text-violet-600">::</code> compresses one run of consecutive all-zero groups.
              ...
              <div className="space-y-1.5 text-xs text-gray-600">
                {[
                  ...
                  <div key={label} className="grid grid-cols-3 gap-1 text-[10px]">
                    ...
                    <span className="text-violet-600">{v6}</span>
                  </div>
                ))}
              </div>
            </ConceptCard>
        ...
        <section>
          <div className="flex items-center gap-4 mb-8">
            <div className="flex-1 h-px bg-gray-200" />
            <div className="flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gray-900 text-white">
          ...
          <p className="text-sm text-gray-500 text-center mb-8">
            Score <strong className="text-gray-700">14 / 20</strong> or higher to unlock Module 5.
          </p>
