  ...
  return (
    <div className="bg-[#0F172A] p-5 flex flex-col gap-5 min-h-[460px]">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <span className="text-[10px] text-gray-500 ml-2">Click any phase to expand details</span>
      </div>
      ...
      <div className="flex justify-between items-start px-4">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[9px] text-gray-500 font-bold uppercase tracking-wide">Browser</span>
          <span className="text-[8px] text-gray-600 font-mono">pandalearn.in</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[9px] text-gray-500 font-bold uppercase tracking-wide">Server</span>
          <span className="text-[8px] text-gray-600 font-mono">203.0.113.42</span>
        </div>
      </div>
            ...
            >
              ...
              <AnimatePresence>
                {isExpanded && (
                  ...
                  >
                    <div
                      className="mx-3 mb-1 px-3 py-2 rounded-b-lg border-x border-b text-[10px] text-gray-300 leading-relaxed"
      ...
      {activePhases >= 0 && (
        ...
        >
          <span className="text-[9px] text-gray-500 uppercase tracking-wider font-bold">DevTools Waterfall</span>
